...
public class Research extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        eRecyclerView = findViewById(R.id.research_rv);
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(final DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists()) {
                    ...
                    for (DataSnapshot postSnapshot : dataSnapshot.getChildren()) {
                        ...
                        if (type.equals("Research and Journal")) {
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(Research.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();
